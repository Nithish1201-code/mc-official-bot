...
export const ConfigSchema = z.object({
  ...
  craftyApiUrl: z.string().url().optional(),
  craftyApiToken: z.string().optional(),
  craftyServerId: z.string().optional(),
  craftyAllowInsecure: z.boolean().optional(),
  serverLoader: z.enum(["paper", "spigot", "bukkit", "fabric", "vanilla"]).optional(),
